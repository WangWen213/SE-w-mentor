...
- **状态**：[x] 已完成
- **阻塞说明**：无。Merged to main with scoped DB/Alembic regression complete; full canonical frontend Vitest remains subject to the documented T003 external-run sandbox exception.
- **Worktree**：`wt-spec-contracts`
...
- **Commit**：branch implementation `14d29e1`; branch metadata `d04c706`, `5489d63`; main integration merge `bfbf9eb`
...
- **状态**：[x] 已完成
- **阻塞说明**：无。Merged to main with scoped model tests, meta/backend regression, Alembic upgrade/downgrade/re-upgrade, and single-head validation complete; full in-sandbox canonical remains subject to the documented T003 Vitest/esbuild native-child restriction.
- **Worktree**：`wt-schema`
...
- **Commit**：implementation `50b30cf`; evidence/metadata `2ccd9b7`; main integration merge `e9246e7`
...
- **Commit**：implementation `5c5db4d`; evidence/metadata `199d981`; main integration merge `597fdd9`
...
- **Commit**：implementation `f7a02a2`; evidence/metadata `98df3f6`; main integration merge `508a539`
